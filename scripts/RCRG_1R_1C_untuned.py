...
from models.single_frame_models import b1_norelations_stage1, RCRG_1R_1C_stage2
...
def train_stage_two(
    ...
    # The Only Difference is that you will not load a checkpoint
