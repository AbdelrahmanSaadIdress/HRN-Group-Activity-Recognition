...
class RCRG_1R_1C_stage2(nn.Module):
    def __init__(self, 
                stage1_model, in_channels=2048,
                hidden_channels=512, output_channels=128,
                num_classes=8
                ):
        super().__init__()
        ...
        self.relational_unit = RelationLayer(in_channels, hidden_channels, output_channels)
...
# model = RCRG_1R_1C_stage2(stage1_model)
# # Random input
# B = 2
# P = 12
